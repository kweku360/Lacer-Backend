...
/**
 * Base class that represents a row from the 'suitcourts' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Suitcourts implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SuitcourtsTableMap';
    ...
    /**
     * The value for the courtid field.
     * @var        int
     */
    protected $courtid;

    /**
     * The value for the courtname field.
     * @var        string
     */
    protected $courtname;
    ...
    /**
     * Initializes internal state of Base\Suitcourts object.
     */
    ...
    /**
     * Compares this with another <code>Suitcourts</code> instance.  If
     * <code>obj</code> is an instance of <code>Suitcourts</code>, delegates to
     * <code>equals(Suitcourts)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Suitcourts The current object, for fluid interface
     */
    ...
    /**
     * Get the [courtname] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SuitcourtsTableMap::COL_ID] = true;
        }
    ...
    public function setSuitid($v)
    {
        ...
        if ($this->suitid !== $v) {
            $this->suitid = $v;
            $this->modifiedColumns[SuitcourtsTableMap::COL_SUITID] = true;
        }
    ...
    public function setSuitnumber($v)
    {
        ...
        if ($this->suitnumber !== $v) {
            $this->suitnumber = $v;
            $this->modifiedColumns[SuitcourtsTableMap::COL_SUITNUMBER] = true;
        }
    ...
    /**
     * Set the value of [courtid] column.
     *
     * @param int $v new value
     * @return $this|\Suitcourts The current object (for fluent API support)
     */
    public function setCourtid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->courtid !== $v) {
            $this->courtid = $v;
            $this->modifiedColumns[SuitcourtsTableMap::COL_COURTID] = true;
        }
    ...
    /**
     * Set the value of [courtname] column.
     *
     * @param string $v new value
     * @return $this|\Suitcourts The current object (for fluent API support)
     */
    public function setCourtname($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->courtname !== $v) {
            $this->courtname = $v;
            $this->modifiedColumns[SuitcourtsTableMap::COL_COURTNAME] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[SuitcourtsTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[SuitcourtsTableMap::COL_MODIFIED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SuitcourtsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SuitcourtsTableMap::translateFieldName('Suitid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->suitid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SuitcourtsTableMap::translateFieldName('Suitnumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->suitnumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SuitcourtsTableMap::translateFieldName('Courtid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->courtid = (null !== $col) ? (int) $col : null;
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSuitcourtsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Suitcourts::setDeleted()
     * @see Suitcourts::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSuitcourtsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SuitcourtsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SuitcourtsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SuitcourtsTableMap::COL_SUITID)) {
            $modifiedColumns[':p' . $index++]  = 'suitid';
        }
        if ($this->isColumnModified(SuitcourtsTableMap::COL_SUITNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'suitnumber';
        }
        if ($this->isColumnModified(SuitcourtsTableMap::COL_COURTID)) {
            $modifiedColumns[':p' . $index++]  = 'courtid';
        }
        ...
        if ($this->isColumnModified(SuitcourtsTableMap::COL_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'modified';
        }

        $sql = sprintf(
            'INSERT INTO suitcourts (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'suitnumber':
                        ...
                        break;
                    case 'courtid':
                        $stmt->bindValue($identifier, $this->courtid, PDO::PARAM_INT);
                        break;
                    case 'courtname':
    ...
    {
        $pos = SuitcourtsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Suitcourts'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Suitcourts'][$this->hashCode()] = true;
        $keys = SuitcourtsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SuitcourtsTableMap::COL_ID)) {
            $criteria->add(SuitcourtsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SuitcourtsTableMap::COL_SUITID)) {
            $criteria->add(SuitcourtsTableMap::COL_SUITID, $this->suitid);
        }
        if ($this->isColumnModified(SuitcourtsTableMap::COL_SUITNUMBER)) {
            $criteria->add(SuitcourtsTableMap::COL_SUITNUMBER, $this->suitnumber);
        }
        if ($this->isColumnModified(SuitcourtsTableMap::COL_COURTID)) {
            $criteria->add(SuitcourtsTableMap::COL_COURTID, $this->courtid);
        }
        if ($this->isColumnModified(SuitcourtsTableMap::COL_COURTNAME)) {
        ...
        if ($this->isColumnModified(SuitcourtsTableMap::COL_MODIFIED)) {
            $criteria->add(SuitcourtsTableMap::COL_MODIFIED, $this->modified);
        }
    ...
    {
        $criteria = ChildSuitcourtsQuery::create();
        $criteria->add(SuitcourtsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Suitcourts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Suitcourts Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(SuitcourtsTableMap::DEFAULT_STRING_FORMAT);
    }
