...
abstract class Token implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TokenTableMap';
    ...
    /**
     * The value for the selector field.
     * @var        string
     */
    protected $selector;
    ...
    /**
     * Initializes internal state of Base\Token object.
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TokenTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [selector] column.
     *
     * @param string $v new value
     * @return $this|\Token The current object (for fluent API support)
     */
    public function setSelector($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->selector !== $v) {
            $this->selector = $v;
            $this->modifiedColumns[TokenTableMap::COL_SELECTOR] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[TokenTableMap::COL_USERID] = true;
        }
    ...
    public function setExpires($v)
    {
        ...
        if ($this->expires !== $v) {
            $this->expires = $v;
            $this->modifiedColumns[TokenTableMap::COL_EXPIRES] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[TokenTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[TokenTableMap::COL_MODIFIED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TokenTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TokenTableMap::translateFieldName('Selector', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selector = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TokenTableMap::translateFieldName('Token', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TokenTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TokenTableMap::COL_SELECTOR)) {
            $modifiedColumns[':p' . $index++]  = 'selector';
        }
        ...
        if ($this->isColumnModified(TokenTableMap::COL_MODIFIED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'selector':
                        $stmt->bindValue($identifier, $this->selector, PDO::PARAM_STR);
                        break;
                    case 'token':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TokenTableMap::COL_ID)) {
            $criteria->add(TokenTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TokenTableMap::COL_SELECTOR)) {
            $criteria->add(TokenTableMap::COL_SELECTOR, $this->selector);
        }
        if ($this->isColumnModified(TokenTableMap::COL_TOKEN)) {
        ...
        if ($this->isColumnModified(TokenTableMap::COL_MODIFIED)) {
            $criteria->add(TokenTableMap::COL_MODIFIED, $this->modified);
        }
