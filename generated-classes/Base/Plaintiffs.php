...
/**
 * Base class that represents a row from the 'plaintiffs' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Plaintiffs implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PlaintiffsTableMap';
    ...
    /**
     * Initializes internal state of Base\Plaintiffs object.
     */
    ...
    /**
     * Compares this with another <code>Plaintiffs</code> instance.  If
     * <code>obj</code> is an instance of <code>Plaintiffs</code>, delegates to
     * <code>equals(Plaintiffs)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Plaintiffs The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PlaintiffsTableMap::COL_ID] = true;
        }
    ...
    public function setSuitnumber($v)
    {
        ...
        if ($this->suitnumber !== $v) {
            $this->suitnumber = $v;
            $this->modifiedColumns[PlaintiffsTableMap::COL_SUITNUMBER] = true;
        }
    ...
    public function setFullname($v)
    {
        ...
        if ($this->fullname !== $v) {
            $this->fullname = $v;
            $this->modifiedColumns[PlaintiffsTableMap::COL_FULLNAME] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[PlaintiffsTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[PlaintiffsTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[PlaintiffsTableMap::COL_MODIFIED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PlaintiffsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PlaintiffsTableMap::translateFieldName('Suitnumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->suitnumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PlaintiffsTableMap::translateFieldName('Fullname', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPlaintiffsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Plaintiffs::setDeleted()
     * @see Plaintiffs::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPlaintiffsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PlaintiffsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PlaintiffsTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PlaintiffsTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PlaintiffsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PlaintiffsTableMap::COL_SUITNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'suitnumber';
        }
        if ($this->isColumnModified(PlaintiffsTableMap::COL_FULLNAME)) {
        ...
        if ($this->isColumnModified(PlaintiffsTableMap::COL_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'modified';
        }

        $sql = sprintf(
            'INSERT INTO plaintiffs (%s) VALUES (%s)',
    ...
    {
        $pos = PlaintiffsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Plaintiffs'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Plaintiffs'][$this->hashCode()] = true;
        $keys = PlaintiffsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(PlaintiffsTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PlaintiffsTableMap::COL_ID)) {
            $criteria->add(PlaintiffsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PlaintiffsTableMap::COL_SUITNUMBER)) {
            $criteria->add(PlaintiffsTableMap::COL_SUITNUMBER, $this->suitnumber);
        }
        if ($this->isColumnModified(PlaintiffsTableMap::COL_FULLNAME)) {
            $criteria->add(PlaintiffsTableMap::COL_FULLNAME, $this->fullname);
        }
        if ($this->isColumnModified(PlaintiffsTableMap::COL_ADDRESS)) {
        ...
        if ($this->isColumnModified(PlaintiffsTableMap::COL_MODIFIED)) {
            $criteria->add(PlaintiffsTableMap::COL_MODIFIED, $this->modified);
        }
    ...
    {
        $criteria = ChildPlaintiffsQuery::create();
        $criteria->add(PlaintiffsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Plaintiffs (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Plaintiffs Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PlaintiffsTableMap::DEFAULT_STRING_FORMAT);
    }
