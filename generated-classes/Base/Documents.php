...
abstract class Documents implements ActiveRecordInterface
{
     ...
     * @var        int
     */
    protected $dataentrypersonid;

    /**
     * The value for the accessstatus field.
     * @var        string
     */
    ...
    /**
     * Get the [dataentrypersonid] column value.
     *
     * @return int
     */
    public function getDataentrypersonid()
    {
        return $this->dataentrypersonid;
    }

    /**
     * Get the [accessstatus] column value.
     *
     * @return string
     */
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_CODE] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_TYPE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_NAME] = true;
        }
    ...
    public function setDatefiled($v)
    {
        ...
        if ($this->datefiled !== $v) {
            $this->datefiled = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_DATEFILED] = true;
        }
     ...
     * @return $this|\Documents The current object (for fluent API support)
     */
    public function setDataentrypersonid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->dataentrypersonid !== $v) {
            $this->dataentrypersonid = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_DATAENTRYPERSONID] = true;
        }

        return $this;
    } // setDataentrypersonid()

    /**
     * Set the value of [accessstatus] column.
     *
     * @param string $v new value
     * @return $this|\Documents The current object (for fluent API support)
     */
    public function setAccessstatus($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->accessstatus !== $v) {
            $this->accessstatus = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_ACCESSSTATUS] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[DocumentsTableMap::COL_MODIFIED] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DocumentsTableMap::COL_ACCESSSTATUS)) {
            $modifiedColumns[':p' . $index++]  = 'accessstatus';
        }
        if ($this->isColumnModified(DocumentsTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }
        if ($this->isColumnModified(DocumentsTableMap::COL_MODIFIED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'dataentrypersonid':
                        ...
                        break;
                    case 'accessstatus':
                        $stmt->bindValue($identifier, $this->accessstatus, PDO::PARAM_STR);
                        break;
                    case 'created':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentsTableMap::COL_ACCESSSTATUS)) {
            $criteria->add(DocumentsTableMap::COL_ACCESSSTATUS, $this->accessstatus);
        }
        if ($this->isColumnModified(DocumentsTableMap::COL_CREATED)) {
            $criteria->add(DocumentsTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(DocumentsTableMap::COL_MODIFIED)) {
            $criteria->add(DocumentsTableMap::COL_MODIFIED, $this->modified);
        }
