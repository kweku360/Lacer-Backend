...
/**
 * Base class that represents a row from the 'lawyers' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Lawyers implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LawyersTableMap';
    ...
    /**
     * Initializes internal state of Base\Lawyers object.
     */
    ...
    /**
     * Compares this with another <code>Lawyers</code> instance.  If
     * <code>obj</code> is an instance of <code>Lawyers</code>, delegates to
     * <code>equals(Lawyers)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Lawyers The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LawyersTableMap::COL_ID] = true;
        }
    ...
    public function setFullname($v)
    {
        ...
        if ($this->fullname !== $v) {
            $this->fullname = $v;
            $this->modifiedColumns[LawyersTableMap::COL_FULLNAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[LawyersTableMap::COL_EMAIL] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[LawyersTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[LawyersTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[LawyersTableMap::COL_MODIFIED] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLawyersQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Lawyers::setDeleted()
     * @see Lawyers::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLawyersQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LawyersTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LawyersTableMap::COL_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'modified';
        }

        $sql = sprintf(
            'INSERT INTO lawyers (%s) VALUES (%s)',
    ...
    {
        $pos = LawyersTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Lawyers'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Lawyers'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LawyersTableMap::COL_MODIFIED)) {
            $criteria->add(LawyersTableMap::COL_MODIFIED, $this->modified);
        }
    ...
    {
        $criteria = ChildLawyersQuery::create();
        $criteria->add(LawyersTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Lawyers (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Lawyers Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(LawyersTableMap::DEFAULT_STRING_FORMAT);
    }
