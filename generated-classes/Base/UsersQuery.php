...
abstract class UsersQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'lacerdb', $modelName = '\\Users', $modelAlias = null)
    {
    ...
    public function filterByCreated($created = null, $comparison = null)
    {
        if (is_array($created)) {
            ...
            if (isset($created['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_CREATED, $created['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($created['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_CREATED, $created['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_CREATED, $created, $comparison);
    }
    ...
    public function filterByModified($modified = null, $comparison = null)
    {
        if (is_array($modified)) {
            ...
            if (isset($modified['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_MODIFIED, $modified['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($modified['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_MODIFIED, $modified['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_MODIFIED, $modified, $comparison);
    }
