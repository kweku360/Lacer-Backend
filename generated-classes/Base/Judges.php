...
/**
 * Base class that represents a row from the 'judges' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Judges implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\JudgesTableMap';
    ...
    /**
     * Initializes internal state of Base\Judges object.
     */
    ...
    /**
     * Compares this with another <code>Judges</code> instance.  If
     * <code>obj</code> is an instance of <code>Judges</code>, delegates to
     * <code>equals(Judges)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Judges The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[JudgesTableMap::COL_ID] = true;
        }
    ...
    public function setFullname($v)
    {
        ...
        if ($this->fullname !== $v) {
            $this->fullname = $v;
            $this->modifiedColumns[JudgesTableMap::COL_FULLNAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[JudgesTableMap::COL_EMAIL] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[JudgesTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[JudgesTableMap::COL_MODIFIED] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildJudgesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Judges::setDeleted()
     * @see Judges::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildJudgesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JudgesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(JudgesTableMap::COL_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'modified';
        }

        $sql = sprintf(
            'INSERT INTO judges (%s) VALUES (%s)',
    ...
    {
        $pos = JudgesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Judges'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Judges'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JudgesTableMap::COL_MODIFIED)) {
            $criteria->add(JudgesTableMap::COL_MODIFIED, $this->modified);
        }
    ...
    {
        $criteria = ChildJudgesQuery::create();
        $criteria->add(JudgesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Judges (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Judges Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(JudgesTableMap::DEFAULT_STRING_FORMAT);
    }
