...
abstract class Notifications implements ActiveRecordInterface
{
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_TYPE] = true;
        }
    ...
    public function setSuitnumber($v)
    {
        ...
        if ($this->suitnumber !== $v) {
            $this->suitnumber = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_SUITNUMBER] = true;
        }
    ...
    public function setDatetimesent($v)
    {
        ...
        if ($this->datetimesent !== $v) {
            $this->datetimesent = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_DATETIMESENT] = true;
        }
    ...
    public function setRecipients($v)
    {
        ...
        if ($this->recipients !== $v) {
            $this->recipients = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_RECIPIENTS] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_STATUS] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[NotificationsTableMap::COL_MODIFIED] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NotificationsTableMap::COL_SUITNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'suitnumber';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_DATETIMESENT)) {
            $modifiedColumns[':p' . $index++]  = 'datetimesent';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_RECIPIENTS)) {
            $modifiedColumns[':p' . $index++]  = 'recipients';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_MODIFIED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotificationsTableMap::COL_SUITNUMBER)) {
            $criteria->add(NotificationsTableMap::COL_SUITNUMBER, $this->suitnumber);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_DATETIMESENT)) {
            $criteria->add(NotificationsTableMap::COL_DATETIMESENT, $this->datetimesent);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_RECIPIENTS)) {
            $criteria->add(NotificationsTableMap::COL_RECIPIENTS, $this->recipients);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_STATUS)) {
            $criteria->add(NotificationsTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_CREATED)) {
            $criteria->add(NotificationsTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(NotificationsTableMap::COL_MODIFIED)) {
            $criteria->add(NotificationsTableMap::COL_MODIFIED, $this->modified);
        }
