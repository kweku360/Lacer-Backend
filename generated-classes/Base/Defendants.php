...
/**
 * Base class that represents a row from the 'defendants' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Defendants implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DefendantsTableMap';
    ...
    /**
     * Initializes internal state of Base\Defendants object.
     */
    ...
    /**
     * Compares this with another <code>Defendants</code> instance.  If
     * <code>obj</code> is an instance of <code>Defendants</code>, delegates to
     * <code>equals(Defendants)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Defendants The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DefendantsTableMap::COL_ID] = true;
        }
    ...
    public function setFullname($v)
    {
        ...
        if ($this->fullname !== $v) {
            $this->fullname = $v;
            $this->modifiedColumns[DefendantsTableMap::COL_FULLNAME] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[DefendantsTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[DefendantsTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[DefendantsTableMap::COL_MODIFIED] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDefendantsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Defendants::setDeleted()
     * @see Defendants::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDefendantsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DefendantsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DefendantsTableMap::COL_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'modified';
        }

        $sql = sprintf(
            'INSERT INTO defendants (%s) VALUES (%s)',
    ...
    {
        $pos = DefendantsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Defendants'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Defendants'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DefendantsTableMap::COL_MODIFIED)) {
            $criteria->add(DefendantsTableMap::COL_MODIFIED, $this->modified);
        }
    ...
    {
        $criteria = ChildDefendantsQuery::create();
        $criteria->add(DefendantsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Defendants (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Defendants Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(DefendantsTableMap::DEFAULT_STRING_FORMAT);
    }
