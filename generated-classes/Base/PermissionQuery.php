 ...
 * @method     ChildPermissionQuery orderByUserid($order = Criteria::ASC) Order by the userid column
 * @method     ChildPermissionQuery orderByCode($order = Criteria::ASC) Order by the code column
 * @method     ChildPermissionQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildPermissionQuery orderByState($order = Criteria::ASC) Order by the state column
 * @method     ChildPermissionQuery orderByCreated($order = Criteria::ASC) Order by the created column
 * @method     ChildPermissionQuery orderByModified($order = Criteria::ASC) Order by the modified column
 *
 * @method     ChildPermissionQuery groupById() Group by the id column
 * @method     ChildPermissionQuery groupByUserid() Group by the userid column
 * @method     ChildPermissionQuery groupByCode() Group by the code column
 * @method     ChildPermissionQuery groupByValue() Group by the value column
 * @method     ChildPermissionQuery groupByState() Group by the state column
 * @method     ChildPermissionQuery groupByCreated() Group by the created column
 * @method     ChildPermissionQuery groupByModified() Group by the modified column
 *
 ...
 * $userCheck->getName();@method     ChildPermission findOneByUserid(int $userid) Return the first ChildPermission filtered by the userid column
 * @method     ChildPermission findOneByCode(int $code) Return the first ChildPermission filtered by the code column
 * @method     ChildPermission findOneByValue(int $value) Return the first ChildPermission filtered by the value column
 * @method     ChildPermission findOneByState(string $state) Return the first ChildPermission filtered by the state column
 * @method     ChildPermission findOneByCreated(int $created) Return the first ChildPermission filtered by the created column
 * @method     ChildPermission findOneByModified(int $modified) Return the first ChildPermission filtered by the modified column *
 ...
 * @method     ChildPermission requireOneByUserid(int $userid) Return the first ChildPermission filtered by the userid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPermission requireOneByCode(int $code) Return the first ChildPermission filtered by the code column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPermission requireOneByState(string $state) Return the first ChildPermission filtered by the state column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPermission requireOneByCreated(int $created) Return the first ChildPermission filtered by the created column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPermission requireOneByModified(int $modified) Return the first ChildPermission filtered by the modified column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPermission[]|ObjectCollection findByUserid(int $userid) Return ChildPermission objects filtered by the userid column
 * @method     ChildPermission[]|ObjectCollection findByCode(int $code) Return ChildPermission objects filtered by the code column
 ...
 * @method     ChildPermission[]|ObjectCollection findByState(string $state) Return ChildPermission objects filtered by the state column
 * @method     ChildPermission[]|ObjectCollection findByCreated(int $created) Return ChildPermission objects filtered by the created column
 * @method     ChildPermission[]|ObjectCollection findByModified(int $modified) Return ChildPermission objects filtered by the modified column
...
abstract class PermissionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'lacerdb', $modelName = '\\Permission', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, userid, code, value, state, created, modified FROM permission WHERE id = :p0';
        try {
    ...
    public function filterByUserid($userid = null, $comparison = null)
    {
        if (is_array($userid)) {
            $useMinMax = false;
            if (isset($userid['min'])) {
                $this->addUsingAlias(PermissionTableMap::COL_USERID, $userid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userid['max'])) {
                $this->addUsingAlias(PermissionTableMap::COL_USERID, $userid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_USERID, $userid, $comparison);
    }
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        if (is_array($code)) {
            $useMinMax = false;
            if (isset($code['min'])) {
                $this->addUsingAlias(PermissionTableMap::COL_CODE, $code['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($code['max'])) {
                $this->addUsingAlias(PermissionTableMap::COL_CODE, $code['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_CODE, $code, $comparison);
    }
    ...
    public function filterByState($state = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_STATE, $state, $comparison);
    }
    ...
    public function filterByCreated($created = null, $comparison = null)
    {
        if (is_array($created)) {
            ...
            if (isset($created['min'])) {
                $this->addUsingAlias(PermissionTableMap::COL_CREATED, $created['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($created['max'])) {
                $this->addUsingAlias(PermissionTableMap::COL_CREATED, $created['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_CREATED, $created, $comparison);
    }
    ...
    public function filterByModified($modified = null, $comparison = null)
    {
        if (is_array($modified)) {
            ...
            if (isset($modified['min'])) {
                $this->addUsingAlias(PermissionTableMap::COL_MODIFIED, $modified['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($modified['max'])) {
                $this->addUsingAlias(PermissionTableMap::COL_MODIFIED, $modified['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_MODIFIED, $modified, $comparison);
    }
