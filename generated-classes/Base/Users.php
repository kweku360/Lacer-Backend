...
abstract class Users implements ActiveRecordInterface
{
    ...
    public function setPicture($v)
    {
        ...
        if ($this->picture !== $v) {
            $this->picture = $v;
            $this->modifiedColumns[UsersTableMap::COL_PICTURE] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[UsersTableMap::COL_CREATED] = true;
        }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[UsersTableMap::COL_MODIFIED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_MODIFIED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_MODIFIED)) {
            $criteria->add(UsersTableMap::COL_MODIFIED, $this->modified);
        }
