...
try{$newLawyer->setPhone1($this->data["vars"]["lawyerContact1"]);}catch (Exception $x){}
try{$newLawyer->setPhone2($this->data["vars"]["lawyerContact2"]);}catch (Exception $x){}
try{$newLawyer->setEmail($this->data["vars"]["lawyerEmail"]);}catch (Exception $x){}
try{$newLawyer->setLawfirmid($this->data["vars"]["lawfirmid"]);}catch (Exception $x){}
